...
\adjustbox{valign=t, padding = 0ex 0ex 0ex 0ex}{\begin{minipage}{0.9\textwidth}%
    \iftoggle{qrcode}{%
...
Die beiden Geraden \(f(x)=x\) und \(g(x)=-x\) nennt man die erste und zweite Winkelhalbierende, da sie jeweils den \(90^\circ\)-Winkel zwischen der \(x\)- und \(y\)-Achse halbieren. Alle Geraden, deren Schaubild durch den Ursprung verläuft, bezeichnet man als Ursprungsgeraden.
\newpage
