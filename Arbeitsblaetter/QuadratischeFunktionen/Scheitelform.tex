...
\end{minipage}}%
\end{minipage}
\textbf{Verschieben in y-Richtung}\vspace{-.3cm}
\begin{tcolorbox}\centering
	\(\textcolor{loestc}{f_v(x)=f(x)+y_S=x^2+y_S}\)
\end{tcolorbox}
\textcolor{loes}{Für \(y_S>0\) wird die Parabel nach oben verschoben, für \(y_S<0\) wird die Parabel nach unten verschoben.}

\bigskip

\textbf{Verschieben in x-Richtung}\vspace{-.3cm}
\begin{tcolorbox}\centering
	\(\textcolor{loestc}{f_v(x)=f(x-x_S)=\left(x-x_S\right)^2}\)
\end{tcolorbox}
\textcolor{loes}{Für \(x_S>0\) wird die Parabel nach rechts verschoben, für \(x_S<0\) wird die Parabel nach links verschoben.}

\bigskip

\textbf{Strecken und Stauchen in y-Richtung}\vspace{-.3cm}
\begin{tcolorbox}\centering
	\(\textcolor{loestc}{f_v(x)=a\cdot f(x)=a\cdot x^2}\)
\end{tcolorbox}
