...
\begin{minipage}{\textwidth}
	\adjustbox{valign=t}{\begin{minipage}{0.5\textwidth}\raggedright
		...
		Grad: \textcolor{loes}{\(5\)}

		Koeffizienten: \textcolor{loes}{\(a_5=-4\), \(a_4=3\), \(a_3=-\frac{1}{2}\),}

		\textcolor{loes}{\(a_2=0\), \(a_1=1\), \(a_0=-3\)}

		Leitkoeffizient \textcolor{loes}{\(a_5=-4\)}

		Absolutglied \textcolor{loes}{\(a_0=-3\)}
	\end{minipage}}%
	\adjustbox{valign=t}{\begin{minipage}{0.5\textwidth}\raggedright
		\(g(x)=x^4+2x^3-0,5x\)
