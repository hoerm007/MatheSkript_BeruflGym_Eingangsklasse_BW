...
\begin{itemize}
	...
	\textcolor{loes}{Nur positive Zahlen unter die Wurzel: \(D=\R^+_0,\ W=\R^+_0\)}\\
	\textcolor{loes}{Gleichungen der Form \(x^n=a,\ n\) gerade haben für \(a>0\) Zwei Lösungen, für \(a=0\) eine Lösung und für \(a<0\) keine Lösung.}
	\item[\textcolor{loes}{\textbullet}] \textcolor{loes}{Ungerade Wurzeln}\\
	\textcolor{loes}{Jede Zahl darf unter die Wurzel geschrieben werden: \(D=\R,\ W=\R\)}\\
    \textcolor{loes}{Gleichungen der Form \(x^n=a,\ n\) ungerade haben immer genau eine Lösung.}
\end{itemize}