...
\usepackage{multirow}
\usepackage{etoolbox}
\usepackage[c]{esvect}						%\vv{arg} Vektoren mit langem Pfeil
\usepackage{physics}						%\abs{} für Beträge
%%%%%%%%%%%%%%%%%%%%%%% MATHE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Spaltenvektoren
\newcommand{\spvv}[2]{\begin{pmatrix} #1 \\ #2 \end{pmatrix}}
\newcommand{\spvvv}[3]{\begin{pmatrix} #1 \\ #2 \\ #3 \end{pmatrix}}
...
\begin{document}
	...
	\title{Mathematik
		...
		Ein Skript für die Eingangsklasse}
    ...
    \begin{tcolorbox}[colframe=red]
        ...
        \href{https://github.com/hoerm007/MatheSkript_BeruflGym_Eingangsklasse_BW}{https://github.com/hoerm007/MatheSkript\_BeruflGym\_Eingangsklasse\_BW}%
    \end{tcolorbox}
    ...
    \def\fktBegriff{./Arbeitsblaetter/Funktionsbegriff}
    ...
    \def\vektor{./Arbeitsblaetter/Vektorgeometrie}
...
%	\newpage
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	\fakesection{Funktionsbegriff}
%	\input{./Arbeitsblaetter/Funktionsbegriff/Funktionsbegriff.tex}%TODO Mehr Beispiele/Aufgaben
%	\newpage
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   \newpage
%   \input{./Arbeitsblaetter/LineareFunktionen/Steigungswinkel.tex}
%   \newpage
%	\input{./Arbeitsblaetter/LineareFunktionen/Nullstellen.tex}
%	\newpage
%	\input{./Arbeitsblaetter/LineareFunktionen/Lage.tex}%TODO Beweis Orthogonalitätsbedingung
%	\newpage
%	\input{./Arbeitsblaetter/LineareFunktionen/Schnittpunkt.tex}
%	\newpage
%   \input{./Arbeitsblaetter/LineareFunktionen/Ungleichungen.tex}%TODO erstellen
%   \newpage
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	\newpage
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	\fakesection{Ganzrationale Funktionen, Hyperbeln und Wurzelfunktionen}
...
%	\newpage
%    \input{./Arbeitsblaetter/GanzrationaleFunktionen/Schaubilder.tex}
%    \newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Symmetrie.tex}
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Verhalten.tex}
%   \newpage
%   \input{./Arbeitsblaetter/GanzrationaleFunktionen/AufgabenZeichnen.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/PotenzfunktionenBruchExp.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Potenzgesetze.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/DefinitionsWertebereich.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Nullstellen.tex}%TODO Wurzelgleichungen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/QuadratischeUngleichungen.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Produktform.tex}%TODO allg. Form für Symmetrie f(x)=f(-x) usw. einführen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Hyperbeln.tex}%TODO Einführung
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Wurzelfunktionen.tex}%TODO
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Wurzelgleichungen.tex}%TODO
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Stetigkeit.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Transformationen.tex}%TODO erstellen
%	\newpage
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/AnwendungUndOptimierung.tex}%TODO erstellen
%	\newpage
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Transformationen.tex}%TODO erstellen
% 	\newpage
% 	\input{./Arbeitsblaetter/EFunktionen/Basiswechsel.tex}%TODO erstellen
% 	\newpage
% 	\input{./Arbeitsblaetter/EFunktionen/Aufgaben.tex}
% 	\newpage
%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   \fakesection{Modellierung}
% 	\input{./Arbeitsblaetter/EFunktionen/Modellierung.tex}%TODO erstellen
% 	\newpage
%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   \fakesection{Vektorgeometrie}
% 	\input{./Arbeitsblaetter/Vektorgeometrie/Vektorbegriff.tex}
% 	\newpage
% 	\input{./Arbeitsblaetter/Vektorgeometrie/Koordinatendarstellung.tex}
% 	\newpage
% 	\input{./Arbeitsblaetter/Vektorgeometrie/Rechenoperationen.tex}%TODO erstellen
%    \newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/Spiegelung.tex}%TODO erstellen
%    \newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/TeilungVonStrecken.tex}%TODO erstellen
% 	 \newpage
 	 \input{./Arbeitsblaetter/Vektorgeometrie/R3.tex}%TODO erstellen
    \newpage
	\input{./Arbeitsblaetter/Vektorgeometrie/Betrag.tex}%TODO erstellen
% 	\newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/Projektion.tex}%TODO erstellen
% 	\newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/SpiegelungAnEbene.tex}%TODO erstellen
%    \newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/Skalarprodukt.tex}%TODO erstellen
%    \newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/Winkel.tex}%TODO erstellen
%    \newpage
%    \input{./Arbeitsblaetter/Vektorgeometrie/AnwendungFiguren.tex}%TODO erstellen
%    \newpage
% 	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
